...
7, Find the function ssh_connect and inside it find the line with variable "command" on it, this is where you set your desired controller location (ip or hostname). Make sure you save it before closing. e.g. ```set-inform http://examplehostname.com:8080/inform``` or ```set-inform http://10.2.15.254/inform```
